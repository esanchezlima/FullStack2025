...
namespace Library.Service.Infrastructure.Http.EndpointHandlers
{
    ...
    {
        public static async Task<Results<BadRequest, Ok<IEnumerable<ExpandoObject>>, Ok<List<AuthorDto>>>> GetAuthorsAsync(
        ...
        public static async Task<Results<BadRequest, NotFound, Ok<ExpandoObject>, Ok<AuthorDto>>> GetAuthorByAuthorIdAsync(
           [FromServices] ILibraryApplicationService _libraryApplicationService,
           [FromServices] ITypeHelperService _typeHelperService,
